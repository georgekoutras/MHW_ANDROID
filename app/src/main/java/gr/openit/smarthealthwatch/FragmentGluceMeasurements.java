 ...
 * Use the {@link FragmentGluceMeasurements#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentGluceMeasurements extends Fragment {
    ...
    UserHome uh;
    public FragmentGluceMeasurements(Context mContext, FragmentMeasurements fm,String displayDate, UserHome uh) {
     ...
     * @return A new instance of fragment FragmentGluceMeasurements.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentGluceMeasurements newInstance(String param1, String param2) {
        FragmentGluceMeasurements fragment = new FragmentGluceMeasurements(null,null,null,null);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_gluce_measurements, container, false);
        gluceBody = root.findViewById(R.id.gluce_measurement_body);
    ...
    private void addGluceTransition(){
        Fragment addGluceFragment = new FragmentAddGluce(mContext,displayDate,uh);
        FragmentManager fm = ((MainActivity)mContext).getSupportFragmentManager();
        FragmentTransaction transaction = fm.beginTransaction();
        transaction.setCustomAnimations(R.anim.enter_from_right, R.anim.exit_to_left, R.anim.enter_from_left, R.anim.exit_to_right);
        transaction.replace(R.id.main_container,addGluceFragment,"toBePoped"); // give your fragment container id in first parameter
        transaction.addToBackStack(null);  // if written, this transaction will be added to backstack
        transaction.commit();
        this.uh.active = addGluceFragment;
    ...
    public void getMeasurements(){
        ...
        try {
            ...
            primaryUserInfoUrl += "?"+URLs.START_TIME+startForQuery+"&"+URLs.END_TIME+endForQuery+"&"+URLs.MEASUREMENT_TYPE+"Σάκχαρο";
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(jsonArray.length() > 0){
                                    title.setText(getString(R.string.gluce_measurements_header));
                                    showGluceData(jsonArray);
                                    gluceBody.setVisibility(View.VISIBLE);
                                }else{
                                    title.setText(getString(R.string.no_gluce_measurements_header,displayDate));
                                    gluceBody.setVisibility(View.GONE);
                                }
    ...
    public void showGluceData(JSONArray data){

        listView=(ListView)root.findViewById(R.id.gluce_measurements_list);
        ...
        for (int i=0; i<data.length(); i++) {
            try {
                ...
                String val2  = measurement.getString("note");
                dataModels.add(new MeasurementRow( String.valueOf(measurement.getInt("id")),time,value,val2));
        ...
        adapter= new ListViewAdapter(dataModels,mContext,this,1);
