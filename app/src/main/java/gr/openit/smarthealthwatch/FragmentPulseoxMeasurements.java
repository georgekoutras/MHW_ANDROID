...
public class FragmentPulseoxMeasurements extends Fragment {
    ...
    public FragmentPulseoxMeasurements(Context mContext, FragmentMeasurements fm, String displayDate, UserHome uh) {
    ...
    public static FragmentPulseoxMeasurements newInstance(String param1, String param2) {
        FragmentPulseoxMeasurements fragment = new FragmentPulseoxMeasurements(null,null,null,null);
    ...
    public void getMeasurements(){
        ...
        try {
            ...
            primaryUserInfoUrl += "?"+URLs.START_TIME+startForQuery+"&"+URLs.END_TIME+endForQuery+"&"+URLs.MEASUREMENT_TYPE+"O2";
