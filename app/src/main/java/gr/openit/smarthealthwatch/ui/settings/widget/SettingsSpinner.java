package gr.openit.smarthealthwatch.ui.settings.widget;
...
public class SettingsSpinner<T> extends LinearLayout
{
    ...
    private String getString(T selectedOption)
    {
        ...
        {
            return gr.openit.smarthealthwatch.ui.settings.util.TextUtils.toTitleCase((String)selectedOption);
        }
        ...
        try
        {
            ...
            {
                return gr.openit.smarthealthwatch.ui.settings.util.TextUtils.toTitleCase(mContext.getString(resId));
            }
        }
        catch(Exception e)
        {
        ...
        return gr.openit.smarthealthwatch.ui.settings.util.TextUtils.toTitleCase(selectedOption.toString());
    }
